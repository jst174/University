...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("src/main/webapp/WEB-INF/views/lessons/fullcalendar3/fullcalendar"), require("jquery"));
	else if(typeof define === 'function' && define.amd)
		define(["src/main/webapp/WEB-INF/views/lessons/fullcalendar3/fullcalendar", "jquery"], factory);
	else if(typeof exports === 'object')
		factory(require("src/main/webapp/WEB-INF/views/lessons/fullcalendar3/fullcalendar"), require("jquery"));
	else
